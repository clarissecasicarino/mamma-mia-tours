...
export default function About(): ReactElement {
  return (
    <main className="mt-14 laptop:mt-16 space-y-6 tablet:space-y-4 desktop:space-y-2">
      <div className="container px-6 tablet:px-8 laptop:px-10 desktop:px-52">
        <h1
        ...
        <div className="pt-6 tablet:pt-8 desktop:pt-10 pb-4">
          <h4
